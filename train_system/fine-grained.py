...
#                 @task
#                 def get_request(self):
#                     self.client.get("/api/v1/adminbasicservice02/adminbasic/stations")
#
# class AdminBasicInfoServiceTask3(TaskSet):
#
#                 @task
#                 def get_request(self):
#                     self.client.get("/api/v1/adminbasicservice03/adminbasic/prices")
#
...
#             self.client.get(f"/api/v1/orderservice02/order/{orderId}")
#
...
#
# class AdminTrainServiceTask(TaskSet):
#
#         @task
#         def get_request(self):
...
#                 price = {
#                           "beyondPrice": 1,
#                           "id": "f31ad892-9f10-4611-acc6-3e44bac77941",
#                           "index": 0,
#                           "initialPrice": 2,
#                           "initialWeight": 1,
#                           "withinPrice": 2
